...
final class EnhancedPoolTests: XCTestCase {
    ...
    func testDemonstrateSizeTracking(poolManager: MemoryPoolManager) async {
    ...
    func testDemonstrateMemoryPressure(poolManager: MemoryPoolManager) async {
        let pool = await poolManager.createEnhancedBufferPool(
            for: "pressure_demo",
            maxPoolSize: 100
        )
    ...
    func testDemonstrateAutoResizing(poolManager: MemoryPoolManager) async {
        let pool = await poolManager.createEnhancedBufferPool(
    ...
    func testDemonstrateDefragmentation(poolManager: MemoryPoolManager) async {
        let pool = await poolManager.createEnhancedBufferPool(
            for: "defrag_demo",
    ...
    func testDemonstrateUsagePatterns(poolManager: MemoryPoolManager) async {
        let pool = await poolManager.createEnhancedBufferPool(
            for: "pattern_demo"
        )
    ...
    func testPrintMemoryReport(poolManager: MemoryPoolManager) async {
