...
final class OptimizationTests: XCTestCase {
    ...
    func testDemonstrateEfficientTraining(
    ...
    func testDemonstrateGradientCheckpointing(pipeline: MetalMLPipeline) async throws {
    ...
    func testDemonstrateMemoryPressureHandling(
        memoryManager: MLMemoryManager,
        bufferPool: PressureAwareBufferPool
    ) async throws {
    ...
    func testDemonstrateMemoryProfiling(pipeline: MetalMLPipeline) async throws {
    ...
    func testDemonstrateBatchProcessing(
        pipeline: MetalMLPipeline,
        memoryManager: MLMemoryManager
    ) async throws {
    ...
    func testComputeSimpleLoss(predictions: MetalBuffer, targets: MetalBuffer) -> Float {
    ...
    func testPrintMemoryStatistics(
        memoryManager: MLMemoryManager,
        bufferPool: PressureAwareBufferPool
    ) async {
