...
final class GraphExecutionTests: XCTestCase {
    ...
    func testDemonstrateFusedOperations(graph: ComputeGraph, device: MTLDevice) async throws {
    ...
    func testDemonstrateMemoryReuse(graph: ComputeGraph, device: MTLDevice) async throws {
    ...
    func testDemonstrateBatchedExecution(graph: ComputeGraph, device: MTLDevice) async throws {
    ...
    func testCreateBuffer(device: MTLDevice, data: [Float]) -> MTLBuffer {
