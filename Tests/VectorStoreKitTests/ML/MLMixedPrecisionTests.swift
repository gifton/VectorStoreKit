...
final class MixedPrecisionTests: XCTestCase {
    ...
    func testDemonstrateMemorySavings() {
        let modelConfigs = [
    ...
    func testDemonstratePrecisionConversion(device: MTLDevice) async throws {
    ...
    func testDemonstrateMixedPrecisionOperations(device: MTLDevice, operations: MetalMLOperations) async throws {
    ...
    func testSimulateMixedPrecisionTraining(device: MTLDevice, operations: MetalMLOperations) async throws {
    ...
    func testComparePerformance(device: MTLDevice, operations: MetalMLOperations) async throws {
    ...
    func testFormatNumber(_ num: Int) -> String {
