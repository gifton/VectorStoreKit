...
final class LSTMTrainingTests: XCTestCase {
    ...
    func testCreateSequenceClassifier(metalPipeline: MetalMLPipeline) async throws -> NeuralNetwork {
    ...
    func testGenerateSequenceData(device: MTLDevice) async throws -> (train: [(MetalBuffer, MetalBuffer)], val: [(MetalBuffer, MetalBuffer)]) {
        let numSamples = 100
    ...
    func testTrainWithAdamW(model: NeuralNetwork, trainData: [(MetalBuffer, MetalBuffer)], valData: [(MetalBuffer, MetalBuffer)]) async throws {
    ...
    func testTrainWithGradientClipping(model: NeuralNetwork, trainData: [(MetalBuffer, MetalBuffer)], valData: [(MetalBuffer, MetalBuffer)]) async throws {
    ...
    func testTrainWithMixedPrecision(model: NeuralNetwork, trainData: [(MetalBuffer, MetalBuffer)], valData: [(MetalBuffer, MetalBuffer)], device: MTLDevice) async throws {
    ...
    func testEvaluateModel(model: NeuralNetwork, valData: [(MetalBuffer, MetalBuffer)]) async {
        var correct = 0
        var total = 0
