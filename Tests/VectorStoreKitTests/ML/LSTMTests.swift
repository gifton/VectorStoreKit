...
final class LSTMTests: XCTestCase {
    ...
    func testSequenceClassificationExample(metalPipeline: MetalMLPipeline) async throws {
    ...
    func testVectorSequenceEncodingExample(metalPipeline: MetalMLPipeline) async throws {
    ...
    func testBidirectionalLSTMExample(metalPipeline: MetalMLPipeline) async throws {
