...
struct ComputeGraphExample {
    ...
    static func demonstrateSimpleGraph(graph: ComputeGraph, device: MTLDevice) async {
    ...
    static func demonstrateNeuralNetworkLayer(graph: ComputeGraph, device: MTLDevice) async {
        // Clear any existing graph
        await graph.clear()
    ...
    static func demonstrateComplexGraph(graph: ComputeGraph, device: MTLDevice) async {
        // Clear any existing graph
        await graph.clear()
