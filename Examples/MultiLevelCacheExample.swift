...
struct MultiLevelCacheExample {
    ...
    static func createMultiLevelCache() async throws -> MultiLevelCachingStrategy<Vector, Metadata> {
    ...
    static func demonstrateBasicOperations(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
    ...
    static func demonstrateLevelPromotion(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
    ...
    static func demonstrateCacheWarming(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
        print("\n--- Cache Warming ---")
    ...
    static func demonstrateMemoryPressure(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
    ...
    static func demonstratePatternAnalysis(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
    ...
    static func demonstrateOptimization(cache: MultiLevelCachingStrategy<Vector, Metadata>) async throws {
        print("\n--- Cache Optimization ---")
    ...
    static func createVector(pattern: VectorPattern) -> Vector {
    ...
    static func printStatistics(cache: MultiLevelCachingStrategy<Vector, Metadata>) async {
        let stats = await cache.statistics()
