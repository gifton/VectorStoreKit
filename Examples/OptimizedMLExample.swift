...
struct OptimizedMLExample {
    ...
    static func benchmarkStandardLinearActivation(device: MTLDevice, ops: MetalMLOperations) async {
        let batchSize = 64
    ...
    static func benchmarkFusedLinearActivation(device: MTLDevice, ops: MetalMLOperations) async {
        let batchSize = 64
    ...
    /// Benchmark buffer pool performance
    static func benchmarkBufferPoolPerformance(device: MTLDevice) async {
    ...
    static func demonstrateGradientClipping(device: MTLDevice, ops: MetalMLOperations) async {
