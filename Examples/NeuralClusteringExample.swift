...
@main
struct NeuralClusteringExample {
    ...
    static func generateDocumentEmbeddings(
        count: Int,
        dimensions: Int,
        numberOfTopics: Int
    ...
    static func generateTopicVector(
        topic: Int,
        dimensions: Int,
        noise: Float
    ) -> [Float] {
    ...
    static func calculateImprovement(initial: TimeInterval, final: TimeInterval) -> Double? {
