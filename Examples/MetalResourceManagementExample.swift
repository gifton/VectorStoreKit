...
@main
struct MetalResourceManagementExample {
    ...
    static func demonstrateBufferPoolUsage(device: MTLDevice) async {
        print("\n1. Buffer Pool Usage")
        print("-------------------")
    ...
    static func demonstrateCommandQueueManagement(device: MTLDevice) async {
    ...
    static func demonstrateMemoryPressureHandling(device: MTLDevice) async {
    ...
    static func demonstrateResourceCleanup(device: MTLDevice) async {
        print("\n4. Resource Cleanup")
        print("------------------")
