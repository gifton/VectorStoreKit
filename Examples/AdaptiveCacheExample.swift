...
struct AdaptiveCacheExample {
    ...
    static func demonstrateSequentialWorkload() async throws {
    ...
    static func demonstrateFrequencyBasedWorkload() async throws {
    ...
    static func demonstrateAdaptiveWorkload() async throws {
    ...
    static func generateSkewedIndex() -> Int {
